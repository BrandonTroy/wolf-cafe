...
//
// @Autowired
// private UserRepository userRepository; // User repository to manage user
// entities
//
// @Autowired
// private OrderRepository orderRepository; // Order repository for order
// management
//
...
// String guestUsername = "guest-" + (userCount + 1); // Create a unique
// username
//
